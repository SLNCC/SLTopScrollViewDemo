...
@interface MainViewController ()<SLTopTitleViewDelegate, UIScrollViewDelegate>
...
- (void)viewDidLoad {
    ...
    self.topTitleView = [SLTopTitleView topTitleViewWithFrame:CGRectMake(0, 0, self.view.frame.size.width, 44)];
    ...
    SLNavigationItemTitleView *view = [[SLNavigationItemTitleView alloc] init];
